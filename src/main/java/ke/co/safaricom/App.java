...
public class App {
    public static void main(String[] args) {
        ...
        CeaserCipher.CeaserCipher ceaserCipher = new CeaserCipher.CeaserCipher(password,key);
        String encryption = ceaserCipher.cipher();
        System.out.println("Encrypted:\t" + encryption);

        //decryption
        CeaserCipher.CeaserCipher ceaserCipherDec = new CeaserCipher.CeaserCipher(encryption,-key);
